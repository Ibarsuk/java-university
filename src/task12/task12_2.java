...
public enum task12_2 {
    ...
    task12_2(double mass, double radius) {
        this.mass = mass;
        this.radius = radius;
    }
    ...
    public static void main(String[] args) {
        ...
        switch (action) {
            ...
            case 4:
                ...
                break;
            case 5:
                task = task12_2.JUPITER;
                System.out.println(task);
                break;
            case 6:
                task = task12_2.SATURN;
                System.out.println(task);
                break;
            case 7:
                task = task12_2.URANIUM;
                System.out.println(task);
                break;
            case 8:
                task = task12_2.NEPTUNE;
                System.out.println(task);
                break;
